...
class Nested_Container_Widget extends Widget_Nested_Base {
	...
	public function get_title() {
		return esc_html__( 'Nested Conainers', 'elementor' );
	}
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Nested_Container_Widget());
