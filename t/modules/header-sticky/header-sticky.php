...
class MetafansCoreCustomizer_Module_Header_Sticky extends MetafansCoreCustomizer_Module_Base {
	...
	function assets() {
		$this->add_css();
		$this->add_js();
		$this->add_local_js_args( 'header_sticky_up', tophive_metafans()->get_setting( 'header_sticky_adv_up' ) );
	}
	...
	function config( $configs ) {
		...
		$render_logo_cb_el = array( Metafans_Customize_Layout_Builder()->get_builder_item( 'header', 'logo' ), 'render' );
...
new MetafansCoreCustomizer_Module_Header_Sticky();