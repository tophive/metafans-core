...
MetafansCoreCustomizer()->register_module(
	'MetafansCoreCustomizer_Module_Typekit',
	array()
);

/**
 * Class MetafansCoreCustomizer_Module_Typekit
 */
class MetafansCoreCustomizer_Module_Typekit extends MetafansCoreCustomizer_Module_Base {
	/**
