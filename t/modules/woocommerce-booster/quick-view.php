...
class MetafansCoreCustomizer_Module_WC_Quick_View extends MetafansCoreCustomizer_Module_Base {

	private $backup_post = null;

	function __construct() {

		if ( ! MetafansCoreCustomizer()->is_enabled_module( 'MetafansCoreCustomizer_Module_WooCommerce_Booster' ) ) {
	 ...
	 */
	function assets() {
		MetafansCoreCustomizer_Module_WooCommerce_Booster::get_instance()->add_css( 'quick-view.css' );
		MetafansCoreCustomizer_Module_WooCommerce_Booster::get_instance()->add_js( 'quick-view.js' );
