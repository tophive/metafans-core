...
MetafansCoreCustomizer()->register_module(
	'MetafansCoreCustomizer_Module_WooCommerce_Booster',
	array()
);
 ...
 * Main module class
 *
 * Class MetafansCoreCustomizer_Module_WooCommerce_Booster
 */
class MetafansCoreCustomizer_Module_WooCommerce_Booster extends MetafansCoreCustomizer_Module_Base {
	 ...
	 * Instance
	 *
	 * @return MetafansCoreCustomizer_Module_WooCommerce_Booster
	 */
	...
	public function assets() {
		$this->is_assets = true;
		$this->add_css();
		if ( ! tophive_metafans()->get_setting( 'wc_cd_disable_tooltip' ) ) {
