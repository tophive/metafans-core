 ...
 */
class Metafans_TI_Add_To_Whishlist extends TInvWL_Public_AddToWishlist {
	 ...
	 * This class
	 *
	 * @var \Metafans_TI_Add_To_Whishlist
	 */
	 ...
	 *
	 * @return \Metafans_TI_Add_To_Whishlist
	 */
	...
	public function button( $echo = true ) {
		...
		$icon_class = ' cd-btn button wishlist-btn display-'.tophive_metafans()->get_setting( 'wc_cd_wishlist_type' );

		$text = MetafansCoreCustomizerduct_Designer::icon_wishlist();
		if ( $label ) {
