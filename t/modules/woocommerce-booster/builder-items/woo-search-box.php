...
class Metafans_Advance_Search_Box {
	...
	public function post_type_field() {
		$search_only_product = tophive_metafans()->get_setting( $this->section . '_search_only_product' );
	...
	public function select_cats_field() {
		$search_only_product = tophive_metafans()->get_setting( $this->section . '_search_only_product' );
		$show_cats = tophive_metafans()->get_setting( $this->section . '_show_cats' );
		if ( $search_only_product && $show_cats ) {
			$all_cats_text = tophive_metafans()->get_setting( $this->section . '_all_cat_text' );
...
new Metafans_Advance_Search_Box();
