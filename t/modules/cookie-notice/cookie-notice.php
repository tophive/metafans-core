...
class MetafansCoreCustomizer_Module_Cookie_Notice extends MetafansCoreCustomizer_Module_Base {
	...
	public function render() {
		...
		if( !tophive_metafans()->get_setting( "{$section}_show_cookie_box" ) ){
			return;
		}
...
new MetafansCoreCustomizer_Module_Cookie_Notice();