...
/**
 * Class MetafansCoreCustomizer_Module_Custom_Fonts
 *
 */
class MetafansCoreCustomizer_Module_Custom_Fonts extends MetafansCoreCustomizer_Module_Base {
    /**
    ...
    function admin_style($hook) {
        ...
        wp_localize_script( 'tophive-custom-fonts', 'Metafans_Fonts_Settings', $this->get_font_exts() );
    }
...
new MetafansCoreCustomizer_Module_Custom_Fonts();