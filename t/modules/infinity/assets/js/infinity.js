...
jQuery(document).ready(function($) {
	...
	if (MetafansCoreCustomizer_JS.infinity_load.products.enable) {
		products_options = {
			type: MetafansCoreCustomizer_JS.infinity_load.products.load_type,
			nextSelector: ".next",
			navSelector: ".navigation",
			itemSelector: "li.product",
			parentSelector: ".woocommerce-listing",
			contentSelector: ".products",
			loadingText: MetafansCoreCustomizer_JS.infinity_load.products.loading_text,
			loadMoreText:
				MetafansCoreCustomizer_JS.infinity_load.products.load_more_text,
			loader:
				'<span class="tophive-infinity-button loading">' +
				MetafansCoreCustomizer_JS.infinity_load.products.loading_text +
				"</span>",
			button:
	...
	if (MetafansCoreCustomizer_JS.infinity_load.posts.enable) {
		posts_options = {
			type: MetafansCoreCustomizer_JS.infinity_load.posts.load_type,
			nextSelector: ".next",
			navSelector: ".navigation",
			itemSelector: "article.entry",
			parentSelector: ".posts-layout-wrapper",
			contentSelector: ".posts-layout",
			loadingText: MetafansCoreCustomizer_JS.infinity_load.posts.loading_text,
			loadMoreText: MetafansCoreCustomizer_JS.infinity_load.posts.load_more_text,
			loader:
				'<span class="tophive-infinity-button loading">' +
				MetafansCoreCustomizer_JS.infinity_load.posts.loading_text +
				"</span>",
			button:
				'<span class="tophive-infinity-button button">' +
				MetafansCoreCustomizer_JS.infinity_load.posts.load_more_text +
				"</span>",
			is_shop: false
		};
