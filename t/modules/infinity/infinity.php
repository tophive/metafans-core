...
class MetafansCoreCustomizer_Module_Infinity extends MetafansCoreCustomizer_Module_Base {
	...
	function get_infinity_settings( $slug = 'posts' ) {
		$settings = array(
			'enable' => tophive_metafans()->get_setting( "infinity_{$slug}_show" ),
			'load_type' => tophive_metafans()->get_setting( "infinity_{$slug}_type" ),
			'loading_text' => tophive_metafans()->get_setting( "infinity_{$slug}_loading_text" ),
			'load_more_text' => tophive_metafans()->get_setting( "infinity_{$slug}_load_more_text" ),
		);
...
new MetafansCoreCustomizer_Module_Infinity();
