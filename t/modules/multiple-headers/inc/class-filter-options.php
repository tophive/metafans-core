...
class MetafansCoreCustomizer_Multiple_Options {
	static $_instance;
	...
	function apply( $force = false ) {
		...
		if ( $force ) {
			$this->is_apply = MetafansCoreCustomizer_Conditional::get_instance()->is();
			$this->is_apply_backup = $this->is_apply;
			return $this->is_apply;
		}
...
MetafansCoreCustomizer_Multiple_Options::get_instance();
