<?php
class Metafans_Builder_Footer_Item_HTML {
	 ...
	 * Optional construct
	 *
	 * Metafans_Builder_Item_HTML constructor.
	 */
...
Metafans_Customize_Layout_Builder()->register_item( 'footer', new Metafans_Builder_Footer_Item_HTML() );

class MetafansCoreCustomizer_Module_HTML_2 extends Metafans_Builder_Footer_Item_HTML {
...
class Metafans_Builder_Item_HTML_2 extends  Metafans_Builder_Item_HTML {
...
class Metafans_Builder_Item_HTML_3 extends  Metafans_Builder_Item_HTML {
...
class Metafans_Builder_Item_Footer_HTML_2 extends  Metafans_Builder_Footer_Item_HTML {
...
class Metafans_Builder_Item_Footer_HTML_3 extends  Metafans_Builder_Footer_Item_HTML {
...
Metafans_Customize_Layout_Builder()->register_item( 'header', new Metafans_Builder_Item_HTML_2() );
Metafans_Customize_Layout_Builder()->register_item( 'header', new Metafans_Builder_Item_HTML_3() );
Metafans_Customize_Layout_Builder()->register_item( 'footer', new Metafans_Builder_Item_Footer_HTML_2() );
Metafans_Customize_Layout_Builder()->register_item( 'footer', new Metafans_Builder_Item_Footer_HTML_3() );
