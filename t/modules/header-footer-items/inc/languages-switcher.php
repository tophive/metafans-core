<?php
class Metafans_Builder_Item_Languages_Switcher {
	public $id;
	public $label;
	public $prefix;
	public $selector;
	...
	function render() {
		...
		$show_name = tophive_metafans()->get_setting( $this->prefix . '_show_name' );
		$show_flag = tophive_metafans()->get_setting( $this->prefix . '_show_flag' );
		$skip_missing = tophive_metafans()->get_setting( $this->prefix . '_skip_missing' );
		$orderby = tophive_metafans()->get_setting( $this->prefix . '_orderby' );
		$order = tophive_metafans()->get_setting( $this->prefix . '_oderby' );
		$aligns = tophive_metafans()->get_setting( $this->prefix . '_sub_align', 'all' );
...
Metafans_Customize_Layout_Builder()->register_item( 'header', new Metafans_Builder_Item_Languages_Switcher() );
