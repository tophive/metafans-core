<?php
class Metafans_Builder_Item_Icon_Box {
	public $id;
	public $label;
	public $prefix;
	public $selector;
	...
	function render() {
		...
		$items = tophive_metafans()->get_setting( $this->prefix . '_items' );
		$algin_desktop = tophive_metafans()->get_setting( $this->prefix . '_display_align', 'desktop' );
		$algin_mobile = tophive_metafans()->get_setting( $this->prefix . '_display_align', 'mobile' );
		$v_in_sidebar = tophive_metafans()->get_setting( $this->prefix . '_vertical_on_sidebar' );
		if ( $v_in_sidebar ) {
...
class Metafans_Builder_Footer_Item_Icon_Box extends Metafans_Builder_Item_Icon_Box {
	public $id;
	public $label;
	public $prefix;
	public $selector;
...
Metafans_Customize_Layout_Builder()->register_item( 'header', new Metafans_Builder_Item_Icon_Box() );
Metafans_Customize_Layout_Builder()->register_item( 'footer', new Metafans_Builder_Footer_Item_Icon_Box() );
