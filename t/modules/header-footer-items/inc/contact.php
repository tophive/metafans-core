<?php
class Metafans_Builder_Item_Contact {
	public $id;
	public $label;
	public $prefix;
	public $selector;
	...
	function render() {
		...
		$align_desktop = tophive_metafans()->get_setting( $this->prefix . '_display_align', 'desktop' );
		$align_mobile = tophive_metafans()->get_setting( $this->prefix . '_display_align', 'mobile' );
...
class Metafans_Builder_Footer_Item_Contact extends Metafans_Builder_Item_Contact {
	public $id;
	public $label;
	public $prefix;
	public $selector;
...
Metafans_Customize_Layout_Builder()->register_item( 'header', new Metafans_Builder_Item_Contact() );
Metafans_Customize_Layout_Builder()->register_item( 'footer', new Metafans_Builder_Footer_Item_Contact() );
