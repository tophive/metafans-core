...
class Metafans_Builder_Item_Secondary_Menu extends Metafans_Builder_Item_Primary_Menu {
	public $id;
	public $label;
	public $prefix;
	public $selector;
...
Metafans_Customize_Layout_Builder()->register_item( 'header', new Metafans_Builder_Item_Secondary_Menu() );
