        ...
        var condition = function ($el) {
            ...
            var c = {
                ...
                save: function(){
                    ...
                    $el.find( '.cond-save' ).addClass( 'loading updating-message' ).text( MetafansCoreCustomizer_Conditional.l10n.loading );
                    var title = $( 'input.cond-name',$el).val() || '';

                    var data = {
                        action: 'tophive-pro/ajax/condition-save',
                        msid: MetafansCoreCustomizer_Conditional.id,
                        title: title,
                        conditionals: values,
                        _nonce: MetafansCoreCustomizer_Conditional._nonce
                    };
                    ...
                    $.ajax( {
                        ...
                        success: function( res ){
                            $el.find( '.cond-save' ).removeClass( 'loading updating-message' ).text( MetafansCoreCustomizer_Conditional.l10n.save );
                            $( '.li-boxed[data-id="'+MetafansCoreCustomizer_Conditional.id+'"] .li-boxed-label' ).text( title );
            ...
            if ( _.size( MetafansCoreCustomizer_Conditional.conditionals ) > 0 ) {
                _.each( MetafansCoreCustomizer_Conditional.conditionals, function( row_values ){
